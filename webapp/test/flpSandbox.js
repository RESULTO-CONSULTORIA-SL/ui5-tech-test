		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 technical test sample ",
									"targetURL": "#comresultoui5techtest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comresultoui5techtest-display": {
								"semanticObject": "comresultoui5techtest",
								"action": "display",
								"description": "Demo intended to review possible intentional errors",
								"title": "UI5 technical test sample ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.resulto.ui5techtest",
									"url": sap.ui.require.toUrl("com/resulto/ui5techtest")
								}
							}
						}
					}
